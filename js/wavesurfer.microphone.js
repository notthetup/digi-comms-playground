/*!
 * wavesurfer.js microphone plugin 3.0.0 (2019-08-24)
    ...
    value: function reloadBuffer(event) {
      if (!this.paused) {
        ...
        if (this.browser.browser === 'edge') {
          ...
          this.wavesurfer.loadDecodedBuffer(this.localAudioBuffer, true);
        } else {
          this.wavesurfer.loadDecodedBuffer(event.inputBuffer, true);
        }
      }
    }
    /**
